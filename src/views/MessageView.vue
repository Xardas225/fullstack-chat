        ...
        <div class="px-20 text-sm">
          ...
          <div class="flex w-[calc(100%-50px)]">
            <div class="inline-block bg-white p-2 rounded-md my-1">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam sunt quibusdam alias minima mollitia neque perferendis. Tempora incidunt rerum nobis itaque, sint sunt aut velit sed asperiores, veritatis, impedit iste.
            </div>
          </div>
